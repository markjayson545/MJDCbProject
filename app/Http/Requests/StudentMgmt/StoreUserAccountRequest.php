...
class StoreUserAccountRequest extends FormRequest
{
    ...
    {
        return [
            'username' => ['required', 'string', 'min:3', 'max:255', 'alpha_dash', 'unique:user_accounts,username'],
            ...
            'student_id' => [
                ...
                Rule::exists('students', 'id')->whereNull('user_account_id'),
            ],
            'teacher_id' => [
                'nullable',
                'integer',
                ...
                Rule::exists('teachers', 'id')->whereNull('user_account_id'),
            ],
