...
@php($student = $student ?? session('student'))
    ...
    <div class="detail-card">
        <div style="margin-bottom: 2rem;">
            <x-profile-picture-upload
                ...
                :display-name="$student->fname.' '.$student->lname"
                :upload-route="route('student.upload-profile-picture')"
                input-id="studentProfilePictureInput"
                container-id="studentProfilePictureContainer"
                image-id="studentProfileImage"
                initials-id="studentProfileInitials"
                status-id="studentUploadStatus"
            />
        </div>
