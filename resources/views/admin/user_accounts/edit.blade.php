...
@section('title', 'Edit User Account — MJDC')
...
@section('content')
	...
	<form action="{{ route('admin.user-accounts.update', $userAccount['id']) }}" method="POST">
		@csrf
		@method('PUT')
		...
		<div class="form-card">
			<div class="form-card-header">
				...
				<div>
					...
					<p>Update the account information below</p>
					<span class="student-name-badge">
						ID #{{ $userAccount['id'] }} — {{ $userAccount['username'] }}
					</span>
				</div>
			</div>
