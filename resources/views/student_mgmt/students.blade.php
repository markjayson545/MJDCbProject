        ...
        <tbody>
            @forelse($students ?? [] as $student)
                <tr style="color: #1e293b !important;">
                    <td style="color: #1e293b !important;">{{ $loop->iteration }}</td>
                    <td>
                        <span class="student-name" style="color: #1a1a2e !important;">{{$student['lname']}}, {{$student['fname']}} {{$student['mname']}}</span>
                    </td>
                    <td style="color: #1e293b !important;">{{ $student['email'] }}</td>
                    <td style="color: #1e293b !important;">{{ $student['contactno'] }}</td>
                    <td style="color: #1e293b !important;">{{ $student['degree']['name'] ?? '—' }}</td>
                    <td style="color: #1e293b !important;">{{ $student['description'] }}</td>
