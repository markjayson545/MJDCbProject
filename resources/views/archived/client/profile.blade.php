...
@section('content')
    <div class="profile-layout">
        <div class="profile-sidebar">
            ...
            <div class="profile-actions">
                ...
                <a href="{{ route('profile.edit') }}" class="cyber-btn-secondary">Change Password</a>
            </div>
        </div>
        ...
        <div class="profile-main">
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-val">Bachelor of Science in Information Technology</span>
                </div>
                <div class="info-row">
    ...
    <div class="notice">
        ...
        <span>This profile currently uses static sample data and can be connected to authenticated user records.</span>
    </div>
@endsection
